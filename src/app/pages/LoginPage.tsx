...
export function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (code === "auth/user-not-found") setError("Apelido não encontrado");
      else if (code === "auth/wrong-password" || code === "auth/invalid-credential") setError("Apelido ou senha incorretos");
    ...
    <div className="flex min-h-screen items-center justify-center bg-white p-4 dark:bg-gray-950">
      ...
      >
        <div className="mb-8 text-center">
          ...
          >
            Acesse sua dashboard de jogadores
          </motion.p>
        </div>
